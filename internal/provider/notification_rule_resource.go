...
func (r *notificationRuleResource) buildNotificationRuleRequestBody(ctx context.Context, plan resource_notification_rule.NotificationRuleModel) (map[string]any, diag.Diagnostics) {
	var diags diag.Diagnostics
