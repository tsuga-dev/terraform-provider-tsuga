...
func MonitorConfigurationAttrTypes() map[string]attr.Type {
	return map[string]attr.Type{
		"metric":         types.ObjectType{AttrTypes: MonitorConfigurationMetricAttrTypes()},
		"log":            types.ObjectType{AttrTypes: MonitorConfigurationLogAttrTypes()},
		"anomaly_log":    types.ObjectType{AttrTypes: MonitorConfigurationAnomalyLogAttrTypes()},
		"anomaly_metric": types.ObjectType{AttrTypes: MonitorConfigurationAnomalyMetricAttrTypes()},
	}
}

func MonitorConfigurationMetricAttrTypes() map[string]attr.Type {
	return map[string]attr.Type{
...
func MonitorConfigurationLogAttrTypes() map[string]attr.Type {
	return map[string]attr.Type{
		"condition":                  types.ObjectType{AttrTypes: MonitorConditionAttrTypes()},
		"no_data_behavior":           types.StringType,
		"timeframe":                  types.Int64Type,
...
func MonitorConfigurationAnomalyLogAttrTypes() map[string]attr.Type {
	return map[string]attr.Type{
...
func MonitorConfigurationAnomalyMetricAttrTypes() map[string]attr.Type {
	return map[string]attr.Type{
		"condition":                  types.ObjectType{AttrTypes: MonitorAnomalyConditionAttrTypes()},
		"no_data_behavior":           types.StringType,
		"timeframe":                  types.Int64Type,
...
func MonitorAnomalyConditionAttrTypes() map[string]attr.Type {
	return map[string]attr.Type{
		"formula":        types.StringType,
