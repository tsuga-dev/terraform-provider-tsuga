...
package resource_ingestion_api_key
...
func IngestionApiKeyResourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			"id": schema.StringAttribute{
				Computed:            true,
				Description:         "Unique identifier of the ingestion API key. Generated by Tsuga.",
				MarkdownDescription: "Unique identifier of the ingestion API key. Generated by Tsuga.",
			},
			"key_last_characters": schema.StringAttribute{
				Computed:            true,
				Description:         "Last visible characters of the secret key. Use this to identify a key without exposing the full secret.",
				MarkdownDescription: "Last visible characters of the secret key. Use this to identify a key without exposing the full secret.",
			},
			"name": schema.StringAttribute{
				Required:            true,
				Description:         "Kebab-case name for the ingestion API key. Maximum length is 100 characters.",
				MarkdownDescription: "Kebab-case name for the ingestion API key. Maximum length is 100 characters.",
			...
			"owner": schema.StringAttribute{
				Required:            true,
				Description:         "Team ID that will own and manage the ingestion API key.",
				MarkdownDescription: "Team ID that will own and manage the ingestion API key.",
				Validators: []validator.String{
			...
			"team_override_fields": schema.ListAttribute{
				ElementType:         types.StringType,
				Optional:            true,
				Computed:            true,
				Description:         "Telemetry attribute names used to override ownership for data sent with this key. Up to 3 fields are allowed.",
				MarkdownDescription: "Telemetry attribute names used to override ownership for data sent with this key. Up to 3 fields are allowed.",
				Validators: []validator.List{
