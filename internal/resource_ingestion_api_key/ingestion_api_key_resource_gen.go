	...
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			"id": schema.StringAttribute{
				Computed:            true,
				Description:         "Tsuga-generated ingestion API key ID assigned when the key is created.",
				MarkdownDescription: "Tsuga-generated ingestion API key ID assigned when the key is created.",
			},
			...
			"team_override_fields": schema.ListAttribute{
				...
				Optional:            true,
				Computed:            true,
				Description:         "Array form. Up to 3 fields are allowed.",
				MarkdownDescription: "Array form. Up to 3 fields are allowed.",
				Validators: []validator.List{
