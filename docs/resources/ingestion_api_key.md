...
- `team_override_fields` (List of String) Array form. Up to 3 fields are allowed.

### Read-Only

- `id` (String) Tsuga-generated ingestion API key ID assigned when the key is created.
